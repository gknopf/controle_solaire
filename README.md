...
ces capteurs sont organisés en secteurs de 1 a 5 circuits  selon l'utilité et communiquent   les données par esp-now vers un concentrateur esp32-c3-supermini
...
l'emmeteur lora tranmet les donnees d'un secteur vers le recepteur lora dans la salle de commande equipé d'un tp-link pour creer un reseau local 
